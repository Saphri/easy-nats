...
/**
 * REST endpoints for typed message publishing with CloudEvents support. Demonstrates type-safe
 * publishing using path-based endpoint separation. Returns proper HTTP status codes: 204 No Content
 * for success, 400 for bad request, 500 for errors.
 */
@Path("/publish")
...
public class OrderPublisherResource {
  ...
  /**
   * Publish a TestOrder payload to NATS. Returns 204 No Content on success, 400 on null, 500 on
   * error.
   *
