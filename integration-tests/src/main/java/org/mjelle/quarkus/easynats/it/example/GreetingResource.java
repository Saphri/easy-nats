 ...
 *
 * <p>Send a POST request to trigger a greeting message that will be received by the {@link
 * GreetingListener}.
 *
 * <p>Example:
 *
...
public class GreetingResource {
  ...
  public GreetingResource(
      @NatsSubject("test.example.greetings") NatsPublisher<GreetingRequest> publisher) {
   ...
   *
   * <p>The message will be published to the "test.example.greetings" subject and received by the
   * {@link GreetingListener}.
   *
