 ...
 *
 * <p>This listener automatically subscribes to the "test.example.greetings" subject when the
 * application starts and prints any received messages to the console.
 */
@ApplicationScoped
public class GreetingListener {
   ...
   *
   * <p>The method will be invoked for each message received, and the message will be automatically
   * acknowledged (ack) on success or negatively acknowledged (nak) if an exception is thrown.
   *
