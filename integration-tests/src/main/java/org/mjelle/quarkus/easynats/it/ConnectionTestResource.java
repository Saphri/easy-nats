 ...
 *
 * <p>Provides endpoints to: 1. Get connection info (server URL, status) 2. Publish messages
 * directly via the connection 3. Check connection status
 */
@ApplicationScoped
@Path("/connection")
@RunOnVirtualThread
public class ConnectionTestResource {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public Map<String, String> publishMessage(@PathParam("subject") String subject, String message) {
    try {
