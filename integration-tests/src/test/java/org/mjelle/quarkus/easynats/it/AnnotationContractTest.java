 ...
 *
 * <p>This test ensures the annotation contract is correctly defined and can be discovered via
...
class AnnotationContractTest {
  ...
  /**
   * Test class with a subscriber method. Not a CDI bean - just for annotation contract testing via
   * reflection.
   */
