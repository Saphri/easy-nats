 ...
 *
 * <p>Tests that NatsConnection: 1. Can be used in try-with-resources blocks safely 2. close()
 * method is a no-op and doesn't close underlying connection 3. Connection remains usable after
