 ...
 *
 * <p>Tests that NatsConnection can be injected into user code and used to: 1. Get connection
 * information (server URL, status) 2. Publish messages directly 3. Verify close() is a safe no-op
