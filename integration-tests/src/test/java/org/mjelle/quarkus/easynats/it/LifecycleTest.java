 ...
 * 1. Is ready for injection immediately after application startup
 * 2. Can be used throughout application lifetime
 * 3. Closes gracefully on application shutdown
 * </p>
 */
@QuarkusTest
