 ...
 *
 * <p>Tests verify that: 1. Producer spans are created when publishing messages 2. Consumer spans
 * are created when receiving messages 3. W3C Trace Context headers are properly propagated 4.
 * Redelivery is properly detected and marked 5. Errors are recorded in spans
 */
@QuarkusTest
...
class TracingTest {
  ...
  @Test
  @DisplayName(
      "T010: Message redelivery is detected and marked with messaging.message_redelivered attribute")
