 ...
 *
 * <p>
 * Tests the CloudEventUnwrapper functionality with various CloudEvent scenarios:
 * 1. Valid binary-mode CloudEvents with proper header structure
 * 2. CloudEvents with different data types
 * 3. CloudEvents with optional vs required attributes
 * </p>
 */
@QuarkusTest
