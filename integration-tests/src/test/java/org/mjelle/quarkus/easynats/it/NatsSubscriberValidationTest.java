 ...
 * - Valid ephemeral mode (subject only) works at runtime
 * - Subscribers can receive messages from NATS
 * - Integration with NATS through Dev Services works correctly
 * </p>
 *
 * <p>
 * Build-time validation of annotation properties (invalid combinations) is tested
 * in the deployment module. This test focuses on runtime behavior with valid configurations.
 * </p>
 */
@QuarkusTest
