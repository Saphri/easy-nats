 ...
 *
 * <p>This record holds information about a method annotated with {@code @NatsSubscriber} that is
...
public record SubscriberMetadata(
  ...
  public boolean isDurableConsumer() {
    return stream != null && !stream.isEmpty() && consumer != null && !consumer.isEmpty();
  }
}
