...
/**
 * Exception thrown when NATS configuration is invalid or missing required properties. This is a
 * domain-specific exception that provides clear error messages for configuration issues.
 */
