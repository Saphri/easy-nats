...
public class CloudEventsHeaders {
   ...
   *
   * <p>Attempts to read the quarkus.application.name property, falls back to the local hostname,
  ...
  public static HeadersWithMetadata createHeadersWithMetadata(
    ...
    CloudEventsMetadata metadata =
        generateMetadata(payloadClass, ceTypeOverride, ceSourceOverride, dataContentType);
    Headers headers = new Headers();
