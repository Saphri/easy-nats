 ...
 * - Required CloudEvents 1.0 headers (ce-specversion, ce-type, ce-source, ce-id) are missing
 * - The ce-specversion is not "1.0"
 * - The message does not follow CloudEvents binary-mode protocol
 * - Structured-mode CloudEvents are detected (not supported)
 * </p>
 */
