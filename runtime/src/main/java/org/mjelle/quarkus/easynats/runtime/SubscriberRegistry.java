 ...
 *
 * <p>This singleton bean holds the metadata for all subscriber methods annotated with
 * {@code @NatsSubscriber}. It is used by the {@code SubscriberInitializer} to create ephemeral
 * consumers and register message handlers at application startup.
 */
@ApplicationScoped
