 ...
 *
 * <p>Indicates whether a type is Jackson-compatible and, if not, provides error details to guide
 * users to the wrapper pattern.
 */
public class TypeValidationResult {
  ...
  public TypeValidationResult(
      boolean valid, String typeName, String errorMessage, ValidationErrorType errorType) {
    this.valid = valid;
