 ...
 *
 * <p>Holds the raw Java class, Jackson's internal type representation, validation results, and the
...
public class MessageType<T> {
  ...
  public String toString() {
    return String.format(
        ...
        rawClass.getSimpleName(), validationResult.isValid(), jacksonType.getTypeName());
  }
