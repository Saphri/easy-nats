 ...
 *
 * <p>This exception is thrown when: - The payload is null - Serialization of the payload fails -
 * The NATS connection is unavailable - The broker rejects the message - Any other NATS publishing
 * operation fails
 */
