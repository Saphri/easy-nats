 ...
 *
 * <p>Wraps a NATS JetStream message and provides type-safe access to a pre-deserialized payload.
 * All control methods (ack, nak, term) are direct pass-through delegations to the underlying NATS
 * message. The payload is deserialized at construction time, not lazily on payload() call.
 *
