...
/** Unit tests for NatsConfiguration. Tests configuration validation rules. */
...
class NatsConfigurationTest {
  ...
  void testValidConfigWithServersOnly() {
    ...
    NatsConfiguration config =
        new TestNatsConfiguration(
            List.of("nats://localhost:4222"), Optional.empty(), Optional.empty(), Optional.empty());
  ...
  @Test
  @DisplayName(
      "Configuration with null servers should pass validation (Dev Services will provide servers)")
  void testConfigWithNullServers() {
    // Given
    NatsConfiguration config =
        new TestNatsConfiguration(null, Optional.empty(), Optional.empty(), Optional.empty());
  ...
  @Test
  @DisplayName(
      "Configuration with empty servers list should pass validation (Dev Services will provide servers)")
  void testConfigWithEmptyServersList() {
    // Given
    NatsConfiguration config =
        new TestNatsConfiguration(List.of(), Optional.empty(), Optional.empty(), Optional.empty());
