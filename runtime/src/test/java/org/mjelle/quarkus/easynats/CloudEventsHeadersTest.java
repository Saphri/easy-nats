...
class CloudEventsHeadersTest {
  ...
  void testCreateHeadersWithExplicitTypeAndSource() {
    Headers headers =
        CloudEventsHeaders.createHeaders(TestClass.class, "com.example.Order", "/order-service");
  ...
  void testCreateHeadersIncludesAllRequiredHeaders() {
    Headers headers =
        CloudEventsHeaders.createHeaders(TestClass.class, "com.example.Event", "/app");
